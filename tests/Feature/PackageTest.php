...
class PackageTest extends TestCase
{
    ...
    {
        // Memanggil endpoint packages
        $response = $this->get('api/packages');

        // Memastikan respon sukses (kode status 200)
        $response->assertStatus(200);

        // Memeriksa apakah ada data paket yang diterima
        $response->assertJsonCount(Package::count(), 'data');
    }
    ...
    public function testCreatePackage()
    {
        $requestData = [
            ...
            "koli_data" => [
                ...
                [
                    ...
                    "koli_volume" => 0,
                    "koli_weight" => 9,
                    "koli_id" => "3600c841-7c86-40f8-b650-75b6a8c0191f",
                    "koli_custom_field" => [
                        "awb_sicepat" => null,
                        "harga_barang" => null
                    ],
                ...
                [
                    ...
                    "koli_volume" => 0,
                    "koli_weight" => 2,
                    "koli_id" => "2937bdbf-6053-4a4d-8c08-2dadcad9202b",
                    "koli_custom_field" => [
                        "awb_sicepat" => null,
                        "harga_barang" => null
                    ],
        ...
        $response = $this->json('POST', 'api/packages', $requestData);
    ...
    public function testGetPackageById()
    {
        ...
        // Mendapatkan ID paket yang ada dalam database
        $packageId = Package::first()->id;

        // Memanggil endpoint packages/{id}
    ...
    public function testUpdatePackage()
    {
        ...
        $response = $this->json('PUT', 'api/packages/' . $packageId, $requestData);
    ...
    public function testPartialUpdatePackage()
    {
        $packageId = Package::first()->id;
        $requestData = [
            "customer_name" => "PT. AMARA Patch",
            "customer_code" => "1678593",
            "transaction_amount" => "70700",
        ];

        $response = $this->json('PATCH', 'api/packages/' . $packageId, $requestData);
    ...
    public function testDeletePackage()
    {
        ...
        $response = $this->delete('api/packages/' . $packageId);
